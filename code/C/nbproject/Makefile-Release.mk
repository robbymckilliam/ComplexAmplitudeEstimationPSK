...
${OBJECTDIR}/CoherentMackenthun.o: CoherentMackenthun.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/CoherentMackenthun.o CoherentMackenthun.cpp

${OBJECTDIR}/LDPCDec.o: LDPCDec.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/LDPCDec.o LDPCDec.cpp
...
${TESTDIR}/tests/CoherentMackenthunTest.o: tests/CoherentMackenthunTest.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -O2 -I. -MMD -MP -MF $@.d -o ${TESTDIR}/tests/CoherentMackenthunTest.o tests/CoherentMackenthunTest.cpp
...
${OBJECTDIR}/CoherentMackenthun_nomain.o: ${OBJECTDIR}/CoherentMackenthun.o CoherentMackenthun.cpp 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/CoherentMackenthun_nomain.o CoherentMackenthun.cpp;\
	else  \
...
${OBJECTDIR}/LDPCDec_nomain.o: ${OBJECTDIR}/LDPCDec.o LDPCDec.cpp 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/LDPCDec_nomain.o LDPCDec.cpp;\
	else  \
