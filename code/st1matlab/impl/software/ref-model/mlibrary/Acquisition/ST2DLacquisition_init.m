function ST2DLacquisition_init(acqparams)
% This function initialises the ST2DL acquisition module and must be called
% prior to running ST2DLacquisition.m. Specifically, this function
% constructs objects for the frequency, time and phase offset estimators.
%
...
%
%   ST2DLacquisition_init(acqparams)
%
% INPUTS:
...
%% construct frequency estimator (periodogram)
...
Nfft = acqparams.Nfft;
if isempty(Nfft)
    error('Set FFT size for the initial frequency estimator.')
end
tauref = 0;
mexFrequencyEstimator(freqEstimatorName,Nfft,Ts,tauref);
...
mexTimingEstimator(timingEstimatorName,PTime,DTime,pTime,T,T/OS,taumin,taumax,rolloff,Tpshape);
