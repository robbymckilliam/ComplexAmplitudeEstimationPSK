...
We now analyse the behaviour of $k_2(\lambda)$.  Firsty consider when, $0 \leq \lambda < \tfrac{\pi}{M}$, then for each integer $k$ and when $\phi \in [\tfrac{ (2k-1)\pi}{M}, \tfrac{(2k+1)\pi}{M} - \lambda )$,
\begin{align*}
