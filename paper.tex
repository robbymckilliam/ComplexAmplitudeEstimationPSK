...
More ambitiously, our techniques might allow analysis of non-data-aided channel estimators for modern communications systems such as mulitple antenna systems, systems employing orthogonal frequency division multiplexing, and systems that must withstand rapidly time varying channels~\cite{4138046,inthft:204506}.  We see the results presented here as a starting point for a potentially potent approach to the analysis of channel estimators that is complementary to the commonplace method of comparing results of Monte-Carlo simulations with Cram\'{e}r-Rao lower bounds.
