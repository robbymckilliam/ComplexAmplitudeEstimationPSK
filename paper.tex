...
\end{align*}
Define the function $Q(\lambda) = \prob G_L^\prime(\lambda)$ and write
\begin{align*}
...
\[
\sqrt{L} Q(\hat{\lambda}_L) = \sqrt{L} Q(0) + \sqrt{L} \hat{\lambda}_L\big( ?  + o_P(1) \big)
\]
...
\[
\sqrt{L}\big( G_L^\prime(\hat{\lambda}_L) - Q(\hat{\lambda}_L) \big) = o_P(1) + \sqrt{L} \big( G_L^\prime(0) - Q(0) \big).
\]
It follows that
\[
