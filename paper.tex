...
Section~\ref{sec:simulations} presents the results of Monte-Carlo simulations.  These simulations agree with the derived asymptotic properties.  Simulations showing the effectivness of our estimator as an initialiser for a turbo synchonisation proceedure are also presented.
