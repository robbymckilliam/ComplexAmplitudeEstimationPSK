...
where
\[
\prob G^\prime_L = \sum_{i \in P}k_1(\lambda)
\]
\end{IEEEproof}

\begin{lemma}~\label{lem:diffatlambdaL}
The derivative of $G_L$ existsm, and is equal to zero, at $\lambda_L$.  That is,
\[
