...
% \end{align}
% where $*$ denotes the complex congugate.  
...
\begin{corollary}
The mean square error of the amplitude estimator $\hat{\rho}$ is $\expect (\rho_0 - \hat{\rho})^2 = B + \rho_0^2(1 - G(0))^2$.
\end{corollary}
