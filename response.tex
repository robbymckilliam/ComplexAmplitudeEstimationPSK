...
Thus, the techniques in our paper can potentially be deployed to accurately model the bias and variance of a non-data-aided SNR estimator in order to implement the reviewers proposal.  We confirm, however, that analysing and implementing the reviewers suggested technique is beyond the scope of the present paper which places primary interest in analysing the least squares estimator.
