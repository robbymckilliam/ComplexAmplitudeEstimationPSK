...
Let the noise sequence $\{w_i\}$ is complex Gaussian with independent real and imaginary parts having zero mean and variance $\sigma^2$.  The joint density function of the real and imaginary parts is
\[
...
\begin{itemize}
\item Run simulations looking at what happens as the number of pilots changes.
\item Simulations showing what happens as $L$ changes for fixed number of pilots.
\item Show that sometimes just using pilots is better!
\end{itemize}
...
\begin{figure}[tp]
	\centering
		...
		\caption{Unbiased amplitude error versus SNR for BPSK with $L=4096$.}
		\label{fig:plotphase}
\end{figure}
...
\begin{figure}[tp]
	\centering
		...
		\caption{Unbiased amplitude error versus SNR for QPSK with $L=4096$.}
		\label{fig:plotphase}
\end{figure}
...
\begin{figure}[tp]
	\centering
		...
		\caption{Unbiased amplitude error versus SNR for $8$-PSK with $L=4096$.}
		\label{fig:plotphase}
\end{figure}
